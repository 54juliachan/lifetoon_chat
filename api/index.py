...
async def welcome(request: WelcomeRequest, authorization: str = Header(None)):
    ...
    try:
        ...
        model = genai.GenerativeModel("gemini-3-flash", system_instruction=BASE_SYSTEM_PROMPT)
...
async def chat(request: ChatRequest, authorization: str = Header(None)):
    ...
    # 4. 呼叫 Gemini
    try:
        model = genai.GenerativeModel("gemini-3-flash", system_instruction=dynamic_system_prompt)
